...
sudo docker stack deploy --with-registry-auth --compose-file $service_path/$service_name/docker-compose-$service_branch_name.yml $service_name-$service_branch_name
